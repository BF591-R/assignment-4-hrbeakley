...
caption_8 <- 'Heatmap of normalized intensity values for differentially expressed probes. Rows represent probes, columns represent samples, and color intensity reflects relative probe expression level'
```
